...
namespace Library.Characters.Heroes
{
    ...
    public class Archer : AbstractHero
    {
        ...
        /// <summary>
        /// Crea un nuevo Archer sin items por defecto (los mismos pueden ser agregados con posterioridad)
        ...
        /// </summary>
        /// <param name="hp">Los puntos de salud base de este Archer.</param>
        /// <param name="damage">El daño base de este Archer.</param>
        /// <param name="defense">La defensa base de este Archer.</param>
        public Archer(int hp, int damage, int defense) : base(hp, damage, defense)
        {
        }
        
        /// <summary>
        /// Crea un nuevo Archer con una lista de items agregados desde una primer instancia.
        /// y subscribe el mismo a la lista de observadores de la <see cref="TorreDeLosCaidos"/>.
        /// </summary>
        /// <param name="hp">Los puntos de salud base de este Archer.</param>
        /// <param name="damage">El daño base de este Archer.</param>
        /// <param name="defense">La defensa base de este Archer.</param>
        /// <param name="items">Los items a agregar a este Archer</param>
